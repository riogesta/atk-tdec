...
<div class="container-xxl flex-grow-1 container-p-y">
	<div class="row">
		<section class="col-sm-6 col-md-3 col-lg-6 mb-4">
			<div class="card">
				<div class="card-body">
				...
				<div class="card-datatable table-responsive">
					<table class="table table-bordered table-striped" id="datatables">
						...
						<tbody>
							...
							<div class="modal fade" id="infoPengajuan<?= $i ?>" aria-hidden="true" data-bs-backdrop="static">
											...
											<form action="/pengajuan/status" method="post">
												...
												<div class="" role="group" aria-label="Basic radio toggle button group">
													<input type="radio" class="btn-check" name="status" id="0-<?= $i ?>"
														autocomplete="off" <?= $row['status'] == '0' ? 'checked':'' ?> value="0">
													...
													<input type="radio" class="btn-check" name="status" id="1-<?= $i ?>"
														autocomplete="off" <?= $row['status'] == '1' ? 'checked':'' ?> value="1">
